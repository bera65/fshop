			...
			<div class="product-purchase-card">
				...
				<div class="productCenter">
					...
					<div class="product-buy-row">
						...
						<button class="btn btn-details cart-button addtocart d-flex align-items-center justify-content-center gap-2{if $hasVariations} requires-variation{/if}" data-id="{$product.id_product}" data-variation="0"{if $hasVariations} disabled{/if}>
					...
					<div class="product-info-grid">
						<div class="product-info-item"><span>{'Stock Code'|translate}</span><strong>{$stockCode|escape}</strong></div>
						<div class="product-info-item"><span>{'Cargo'|translate}</span><strong>{if $price >= $freeCargo}{'Free'|translate}{else}{Tools::displayPrice($cargoPrice)}{/if}</strong></div>
						<div class="product-info-item product-info-item--wide"><span>{'Cargo Day'|translate}</span><strong>{$cargoDay} {'Day(s)'|translate}</strong></div>
					</div>
