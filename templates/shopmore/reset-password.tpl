				...
				<form method="post" action="{$domain}reset-password?token={$resetToken|escape:'url'}" class="auth-form">
					...
					<div class="mb-3">
						...
						<div class="auth-password-wrap">
							...
							<input type="password" id="resetPassword" name="password" class="form-control" minlength="8" required autocomplete="new-password">

							<button type="button" class="auth-password-toggle" data-target="#resetPassword" data-show-label="{'Show password'|translate|escape}" data-hide-label="{'Hide password'|translate|escape}" aria-label="{'Show password'|translate}">
					...
					<div class="mb-4">
						...
						<div class="auth-password-wrap">
							...
							<input type="password" id="resetPassword2" name="password2" class="form-control" minlength="8" required autocomplete="new-password">

							<button type="button" class="auth-password-toggle" data-target="#resetPassword2" data-show-label="{'Show password'|translate|escape}" data-hide-label="{'Hide password'|translate|escape}" aria-label="{'Show password'|translate}">
