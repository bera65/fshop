<header class="header-wrapper">
	<div class="top-bar">
		<div class="container d-flex align-items-center justify-content-between">
			<ul class="top-menu">
				<li class="top-menu-item">{include file='shopmore/plugin/lang-switcher.tpl'}</li>
			...
			<div class="logo ps-2 mobileLogoDiv">
				<a href="{$domain}" class="site-logo-img mobileLogo" title="{$siteName}">
					<img src="{$siteLogos.header|escape}?v={$minute|default:1}" alt="{$siteName}"/>
				</a>
			</div>
		...
		<div class="container d-flex align-items-center justify-content-between w-full">
			<div class="logo-area">
				<a href="{$domain}" class="site-logo-img" title="{$siteName}">
					<img src="{$siteLogos.header|escape}?v={$minute|default:1}" alt="{$siteName}" width="60%"/>
				</a>
			</div>
