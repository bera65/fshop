    ...
    <div class="container custom-container">
        <div class="row g-4 text-small">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="sm-footer-about">
                    <a href="{$domain}" class="sm-footer-about__logo" title="{$siteName|escape}">
                        <img src="{$siteLogos.footer|escape}?v={$minute|default:1}" alt="{$siteName|escape}" height="65">
                    </a>
                    <p class="sm-footer-about__text text-secondary small">
                        {if $footerDescription|default:'' != ''}
                        {$footerDescription|escape}
                        {else}
