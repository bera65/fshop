						...
						<form id="authModalLoginForm" class="auth-form">
							...
							<div class="mb-3">
								...
								<div class="auth-password-wrap">
									...
									<button type="button" class="auth-password-toggle" data-target="#authModalLoginPassword" data-show-label="{'Show password'|translate|escape}" data-hide-label="{'Hide password'|translate|escape}" aria-label="{'Show password'|translate}">
					...
					<div class="tab-pane fade" id="auth-register-pane" role="tabpanel">
						...
						<form id="authModalRegisterForm" class="auth-form">
							...
							<div class="mb-3">
								...
								<div class="auth-password-wrap">
									<input type="password" id="authModalRegisterPassword" name="password" class="form-control" placeholder="{'Password placeholder'|translate}" required autocomplete="new-password" minlength="8">
									<button type="button" class="auth-password-toggle" data-target="#authModalRegisterPassword" data-show-label="{'Show password'|translate|escape}" data-hide-label="{'Hide password'|translate|escape}" aria-label="{'Show password'|translate}">
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"/><circle cx="12" cy="12" r="3"/></svg>
									</button>
								</div>
