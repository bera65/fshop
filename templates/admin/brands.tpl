				...
				<tr>
					...
					<td class="text-end">
						<form action="" method="POST">
							...
							<button type="submit" name="deleteBrand" value="{$adminToken}" class="btn btn-danger btn-sm js-admin-confirm" data-confirm-title="{'Delete brand'|adminT}" data-confirm-message="{'Are you sure you want to delete this brand? The brand record will be permanently removed.'|adminT}">
