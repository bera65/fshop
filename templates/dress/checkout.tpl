...
<div class="row g-4 g-xl-5 checkout-page__grid">
	<div class="col-lg-7">
		{if $isLoggedIn}
		...
		<div class="checkout-auth">
			...
			<div class="checkout-auth__grid">
				<div class="checkout-auth-card">
					...
					{include file='shopmore/plugin/google-login-btn.tpl' googleLoginCompact=true}
				...
				<div class="checkout-section__body">
					...
					<div id="checkoutAddressFields" class="checkout-fields">
						<div class="row g-3">
							...
							<div class="col-12">
								<div class="form-check checkout-gift">
			...
			<section class="checkout-section">
				...
				<div class="checkout-section__body">
					...
					<div class="checkout-payment-list">
						...
						{if $method.id == 'cash_on_delivery' && $cartHasVirtual}{continue}{/if}
						<label class="checkout-payment-card">
							<input type="radio" name="payment_method" value="{$method.id|escape}"{if $formData.payment_method == $method.id} checked{/if}>
							<span class="checkout-payment-card__body">
								<span class="checkout-payment-card__icon">
								...
								<span>
									<strong>{$method.label|escape}</strong>
								</span>
							</span>
						</label>
						{/foreach}
						{else}
						<p class="text-muted mb-0">{'No payment methods available'|translate}</p>
						{/if}
					</div>
					{/if}
