...
<form method="get" action="{$catalogBaseUrl|escape}" class="prime-filter-form mt-3">
	...
	<div class="prime-filter__group">
		...
		<ul class="prime-filter-list{if $filterSubcategories|@count > 6} prime-filter-list--scroll{/if}">
			<li>
	...
	<div class="prime-filter__group">
		...
		<ul class="prime-filter-list{if $filterBrands|@count > 5} prime-filter-list--scroll{/if}">
	...
	<div class="prime-filter__group">
		...
		<ul class="prime-filter-list{if $varGroup.values|@count > 6} prime-filter-list--scroll{/if}">
			<li>
				<label class="prime-filter-check">
